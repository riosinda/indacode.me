    ...
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="flex flex-col sm:flex-row gap-10 mb-16">
        <div className="shrink-0">
          <div className="w-40 h-40 rounded-full overflow-hidden border border-border">
            <Image
        ...
        <div className="flex flex-col gap-4 justify-center">
          ...
          <div className="flex items-center gap-3 mt-2">
            <a
              ...
              className="flex items-center gap-2 border border-border px-3 py-1.5 rounded-full text-xs text-text-secondary hover:border-accent hover:text-accent transition-all duration-200"
            >
